#!/bin/bash
#SBATCH --job-name=maskrcnn_seed_v04_run1
#SBATCH --time=8:00:00
#SBATCH -p gpu
#SBATCH --gres=gpu:1
#SBATCH --mem=32G
...
python3 /oscar/data/dharri15/eaguerov/Github/Bubble-tracking/bubbly_flows/scripts/train_maskrcnn.py \
    --dataset /oscar/data/dharri15/eaguerov/Github/Bubble-tracking/bubbly_flows/microsam/datasets/seed_v04_train \
    --name maskrcnn_seed_v04_run1 \
    --epochs 100 \
